          ...
          <CCard>
            ...
            <CCardFooter  style={{padding:0}}>
                ...
                <div style={{display:'flex' ,}}>
                    <p style={{fontWeight:'bold',padding:8}}><span style={{color:'Blue'}}>Name:</span><span style={{color:'Red'}}>{x.name}</span></p>
            
                </div>
                <div style={{lineHeight:0,marginBottom:5, marginLeft:0,marginRight:0,padding:8}}>
            <p><span style={{color:'Blue'}}>Role:</span> <span style={{color:'green'}}>{x.role}</span></p>
            <p><span style={{color:'Blue'}}>Email:</span><span style={{color:'black'}}>{x.email}</span></p>
                           </div>
                           </div>
