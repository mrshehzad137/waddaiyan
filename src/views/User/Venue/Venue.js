              ...
              <CCol xs="12" sm="6" md="3">
                <CCard>
                  <CCardBody style={{ padding: 0 }}>
                    <CLink to={`./staticdetailPage/${x._id}`}> <img src={datapicture[Math.floor(Math.random() * 12)]} style={{ width: 300, height: 200, }}></img></CLink>
                  </CCardBody>
                  <CCardFooter style={{ padding: 0 }}>
                    <div style={{ borderBottom: '1px dashed grey' }}>
                      ...
                      <div style={{ display: 'flex', lineHeight: 0, marginBottom: 5, marginLeft: 0, marginRight: 0, padding: 8 }}>
                        <p>{x.location}</p>
                        <p style={{ position: 'absolute', color: 'red', backgroundColor: 'yellow', width: '100px', textAlign: 'center', marginLeft: 100,right:'0px' }}>Rs:{x.charges} PKR</p>
                      </div>
                    </div>
